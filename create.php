...
<meta name="yahoo" content="noindex, follow" />
<meta name="Mediapartners-Google" content="index, follow" />
<meta property="og:url" content="http://www.marksikaundi.me/auth/login" />
<meta property="og:type" content="website" />
<meta name="msvalidate.01" content="BC5450558E65B418CA902EF01FD0D85E" />
<script type="text/javascript">window._taboola=window._taboola||[];_taboola.push({home:'auto'});!function(e,f,u,i){if(!document.getElementById(i)){e.async=1;e.src=u;e.id=i;f.parentNode.insertBefore(e,f);}}(document.createElement('script'),document.getElementsByTagName('script')[0],'//cdn.taboola.com/libtrc/asahainc/loader.js','tb_loader_script');if(window.performance&&typeof window.performance.mark=='function'){window.performance.mark('tbl_ic');}</script>
...
<script>var user={member:'0',premium:'0',email:'0',customer_id:'0',card_removed:'0'};var page='auth/login';</script>
...
<!--<img src="/assets/evelyn.svg" id="logo-img" border="0" title="" alt="Evelyn Technology" />-->
</a>
</div>
<form action="/search" id="m-search-form">
<input type="text" maxlength="200" name="q" id="m-q" autocomplete="off" placeholder="Search for books" value="" required />
<button type="submit" style="position: absolute;top: 13px;right: 12%;color: #6b6b6b;border: none;padding: 0;background: none;">
...
<input type="text" maxlength="200" name="q" id="q" autocomplete="off" placeholder="The team welcome you, Here is your search windows" value="" required />
...
<a href="/donate.html" id="upload-top" class="user-info-inner"><i class="fa fa-heart" aria-hidden="true" style="color:#FC121E"></i> Donate</a>
<a href="https://www.github.com/marksikaundi" id="premium-top" class="user-info-inner" style="color: #1db954;font-weight: 500;margin-right: 13px;font-size: 17px;">Github</a>
<a class="btn-g hidemobile" href="/sign.html" role="button" rel="nofollow">Sign in</a>
<button id="btnLang" type="button" class="btn btn-primary btn-more dropdown-toggle dropdown-toggle-no-arrow hidemobile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="margin: -2px 0px 0px 5px;">
<i class="fas fa-globe"></i>
</button>
<div class="dropdown-menu dropdown-menu-right hidemobile" aria-labelledby="btnLang">
<a href="https://www.marksikaundi.me setLocal?url=auth/login?redirURL=%2F" rel="nofollow" class="dropdown-item" onclick="ga('send', 'event', 'ChangeLanguage', 'English');">English</a>
<a href="https://es.marksikaundi.me setLocal?url=auth/login?redirURL=%2F" rel="nofollow" class="dropdown-item" onclick="ga('send', 'event', 'ChangeLanguage', 'Español');">Español</a>
<a href="https://ru.marksikaundi.me setLocal?url=auth/login?redirURL=%2F" rel="nofollow" class="dropdown-item" onclick="ga('send', 'event', 'ChangeLanguage', 'Русский');">Русский</a>
<a href="https://www.pdfdrive2.com/home/setLocal?url=auth/login?redirURL=%2F" rel="nofollow" class="dropdown-item" onclick="ga('send', 'event', 'ChangeLanguage', 'Türkçe');">Türkçe</a>
</div>
</div>
<button id="btnLangMobile" type="button" class="btn btn-primary btn-more dropdown-toggle dropdown-toggle-no-arrow hidedesktop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
<i class="fas fa-globe"></i>
</button>
...
<a href="https://es.marksikaundi.me setLocal?url=auth/login?redirURL=%2F" rel="nofollow" class="dropdown-item" onclick="ga('send', 'event', 'ChangeLanguage', 'Español');">Español</a>
<a href="https://ru.marksikaundi.me setLocal?url=auth/login?redirURL=%2F" rel="nofollow" class="dropdown-item" onclick="ga('send', 'event', 'ChangeLanguage', 'Русский');">Русский</a>
<a href="https://www.marksikaundi.me/home/setLocal?url=auth/login?redirURL=%2F" rel="nofollow" class="dropdown-item" onclick="ga('send', 'event', 'ChangeLanguage', 'Türkçe');">Türkçe</a>
</div>
...
<a class="btn-g" href="https://github.com/marksikaundi" role="button" onclick="ga('send', 'event', 'Premium', 'Mobile menu');" style="margin: 35px 15px 0px 5px; float: right;">
Go Github </a>
</ul>
...
<h2 class="form-signin-heading mb-3">Create</h2>
<input type="hidden" name="redirURL" value="/">
<div class="form-group field">
<input type="text" id="inputIdentity" name="identity" class="form-control" placeholder="Enter your fullname" required autofocus value="">
<label for="inputIdentity">Full Name</label>
</div>

<input type="hidden" name="redirURL" value="/">
<div class="form-group field">
<input type="email" id="inputIdentity" name="identity" class="form-control" placeholder="Email Address" required autofocus value="">
<label for="inputIdentity">Email Address</label>
</div>

<div class="form-group field">
<input type="password" name="password" id="inputPassword" class="form-control" placeholder="Password" required>
<label for="inputPassword">Password</label>
<a href="/sign.html/forgot_password" style="font-size: 13px; text-transform: none;margin-left: 3px;">Forgot Password?</a>
</div>
<div>
<label>
<input type="checkbox" name="remember" value="1" checked="checked"> Remember me </label> <button class="btn btn-primary btn-responsive pull-right" type="submit"><i class="fas fa-sign-in-alt"></i> Create</button>
</div>

<input type="hidden" name="recaptcha_response" id="recaptchaResponseLogin">
</form>
<p class="text-center mt-4" style="font-size:18px; color:#000;">
<a href="/sign.html" class="btn btn-outline-primary">Sign In</a>
</p>
</div>
</div>
<script>$(document).ready(function(){$.getScript("https://www.google.com/recaptcha/api.js?render=6Lfo3eoUAAAAAG1agFKNm0HMJiuml_Dee8kdr1nz").done(function(script,textStatus){grecaptcha.ready(function(){grecaptcha.execute('6Lfo3eoUAAAAAG1agFKNm0HMJiuml_Dee8kdr1nz',{action:'share'}).then(function(token){var recaptchaResponse=document.getElementById('recaptchaResponseLogin');recaptchaResponse.value=token;});});});});</script>
<div class="dialog-right">
<div id="user-menu-right"></div>
<div style="font-size:14px;" class="mr-1 mb-2"><i class="fab fa-hotjar"></i>
<a href="/email" style="font-weight: 500;" onclick="ga('send', 'event', 'hope-promo', 'maincats');">CS60APA:hope</a> Give away. Free Building materials.</a></div>
...
<input type="text" autocomplete="on" name="email" required value="" class="form-control" id="email-cats" placeholder="Enter your email">
...
<div>
<a href="/app"><img alt="" title="research centre" src="" style="width: 170px; margin-left: -10px;" /></a>
</div>
<div id="rc-widget-9eec7a" data-rc-widget data-widget-host="habitat" data-endpoint="//trends.revcontent.com" data-widget-id="115247"></div>
<script type="text/javascript" src="//assets.revcontent.com/master/delivery.js" defer="defer"></script>
</div>
<div style="clear:both;"></div>
</div> <div class="modal fade" id="pdfdriveAlerts" tabindex="-1" role="dialog" aria-labelledby="pdfdriveAlerts">
...
<i class="fas fa-times" style="position: absolute;top: 0px;right: 0px;padding: 9px;color: #fff;cursor:pointer;" onclick="$('#pdfdriveAlerts').modal('hide')"></i>
...
<input type="text" autocomplete="on" name="email" required value="" class="alerts-email form-control" id="email-alerts" placeholder="Enter your email">
<span class="input-group-btn">
<button type="submit" class="btn btn-danger subscribe-btn">Subscribe</button>
</span>
</div>
...
<!--<img src="/assets/evelyn.svg" width="175" border="0" title="PDF Search Engine" alt="Evelyn Technology-Research" style="padding-top: 45px;" />-->
</a>
</div>
<div class="footer-section">
<div class="footer-title" title="0.0057 / 15-10-2021 04:19:56 / 195.201.87.181">
Company </div> <br />
...
<script type="text/javascript">$(document).ready(function(){window._taboola=window._taboola||[];_taboola.push({flush:true});});</script>
</body>
</html>